...
def pipeline_honorarios(df_honorarios):
    ...
    mapa_replace_data= {
        ...
        #LEMBRAR DE PERGUNTAR O QUE FAZER COM OS NULOS
    ...
    # O na=False serve para o pandas não dar erro se esbarrar em um campo vazio (nulo)
    ...
    df_honorarios['data_vencimento']= pd.to_datetime(df_honorarios['data_vencimento'], dayfirst= True, format='mixed')                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         
    ...
    print(df_honorarios['valor_em_aberto'].isnull().sum())
