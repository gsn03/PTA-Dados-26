...
tabela_clientes = pd.read_csv(caminho_entrada)

def pipeline_clientes(df):
    
    #Remoção de duplicatas:         
    df = df.drop_duplicates(subset=["cpf"], keep="first", ignore_index=False)    
...
pipeline_clientes(tabela_clientes)
